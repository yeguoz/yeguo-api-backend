...
(
    ...
    gold_coin     bigint unsigned  default 40                                                       not null comment '金币',
...
(
    ...
    method              varchar(128)                                                                                   null comment '接口方法',
    url                 varchar(1024)                                                                                  null comment '接口地址',
    ...
    avatar_url          varchar(1024)    default 'https://cdn.jsdelivr.net/gh/ye-guo/Images/images/2.jpg' not null comment '接口头像',
